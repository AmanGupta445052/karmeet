    ...
    <>
      <nav className="bg-white text-black w-screen divide-x divide-black-200">
        <div className="p-4 flex items-center relative">
          ...
          <div className='ml-96 right-0 bg-black absolute w-52 h-full text-2xl hover:border-l-amber-400 text-white justify-center items-center p-3 pt-5 pl-5'>
      ...
      <div className='w-screen h-[646px] flex'>
        <div className='w-1/2 h-[646px] bg-[#5D5FEF] flex flex-col justify-center items-center'>
          ...
          <div className="flex justify-center space-x-4">
            <button className='bg-black w-52 h-16 rounded-2xl text-white text-2xl '><Link to="/register">Email Signup</Link></button>
            <button className='bg-white w-52 h-16 rounded-2xl text-black text-[24px] border-2 border-black flex  justify-center items-center ' onClick={handleGoogleSignUp}>
      ...
      <div className='h-[300px] w-screen bg-indigo-900'>
        <div className='w-screen h-[220px] space-x-48 flex '>
          ...
          <div className='text-2xl text-white ml-auto pt-5 pr-20 '><h2 className='flex mb-2 '>Services</h2>
          <h4 className='text-xl mb-2'>Chat Application</h4>
          <p className='text-xl'>Video Conference and Collaboration</p>
          </div>
          <div className='text-2xl text-white h-10 ml-auto pt-5 pr-20 pointer '  onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}><h2 className='hover:bg-slate-500 hover:rounded-lg cursor-pointer'>Navigation</h2></div>
        </div>
